...
impl FromPath for RestServerConfig {}

impl ConfigInto<RestServer> for RestServerConfig {}
...
#[async_trait]
impl FromConfig<RestServerConfig> for RestServer {
    async fn from_config(config: &RestServerConfig) -> anyhow::Result<Self> {
...
#[async_trait]
impl Listen<Vec<u8>, RestServerConfig> for RestServer {
