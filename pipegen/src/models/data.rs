...
pub fn data_ty_to_literal(ty: &DataType) -> String {
    match ty {
        ...
        DataType::Date => "chrono::NaiveDate".to_owned(),
        DataType::DateTime => "chrono::NaiveDateTime".to_owned(),
        DataType::Duration => "chrono::Duration".to_owned(),
        DataType::LocalTime => "chrono::DateTime<chrono::Local>".to_owned(),
        DataType::UtcTime => "chrono::DateTime<chrono::Utc>".to_owned(),
        DataType::Period => "pipebase::common::Period".to_owned(),
        DataType::Timestamp => "pipebase::common::Timestamp".to_owned(),
